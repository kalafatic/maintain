...
/**
 * The Class class RelEngPerspective.
...
public class RelEngPerspective implements IPerspectiveFactory {
	...
	/** The Constant ID. */
	public static final String ID = "eu.kalafatic.maintain.core.perspectives.RelEngPerspective";

	/** The factory. */
	private IPageLayout factory;

	/**
	 * Instantiates a new rel eng perspective.
	 */
