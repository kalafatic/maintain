 ...
 * @generated
 */
public class MaintainSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MaintainPackage.MAINTAIN: {
				Maintain maintain = (Maintain)theEObject;
				T result = caseMaintain(maintain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaintainPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaintainPackage.STRING_TO_NODE_MAP_ENTRY: {
			...
			case MaintainPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = caseNode(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaintainPackage.SUBPROJECT: {
				Subproject subproject = (Subproject)theEObject;
				T result = caseSubproject(subproject);
				if (result == null) result = caseProject(subproject);
				if (result == null) result = caseNode(subproject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaintainPackage.SERVICE: {
			...
			case MaintainPackage.MACHINE: {
				Machine machine = (Machine)theEObject;
				T result = caseMachine(machine);
				if (result == null) result = caseNode(machine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaintainPackage.METADATA: {
				Metadata metadata = (Metadata)theEObject;
				T result = caseMetadata(metadata);
				if (result == null) result = caseNode(metadata);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
